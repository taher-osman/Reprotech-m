...
const FertilizationAnalytics: React.FC = () => {
  ...
  const handleExportData = () => {
    const exportData = {
      fertilizationMetrics: analyticsData?.fertilizationMetrics,
      developmentStages: analyticsData?.developmentStages,
    ...
    link.href = url;
    link.download = `fertilization-analytics-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
...
export default FertilizationAnalytics; 